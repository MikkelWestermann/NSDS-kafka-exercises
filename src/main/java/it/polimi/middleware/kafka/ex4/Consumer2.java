...
public class Consumer2 {
  ...
  public static void main(String[] args) {
    ...
    HashMap<String, Integer> messageCountMap = new HashMap<>();
    ...
    while (true) {
      ...
      for (final ConsumerRecord<String, String> record : records) {
        ...
        messageCountMap.putIfAbsent(key, 0);
        ...
        for (String k : messageCountMap.keySet()) {
          final ProducerRecord<String, String> newRecord = new ProducerRecord<>(newTopic, k,
              messageCountMap.get(k).toString());
